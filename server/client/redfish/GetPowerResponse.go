...
// PowerMetrics is power readings for this chassis.
...
// PowerLimit object contains power limit status and configuration information for the chassis.
...
// PowerControl is the definition for power control function (power reading/limiting).
...
// PowerSupply is the power supply hardware.
...
// GetPowerResponse is the response of power system info.
