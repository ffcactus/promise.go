...
// Status includes State and Health.
type Status struct {
	State  string `json:"State"`
	Health string `json:"Health"`
}

// Resource includes basic resource info.
...
// Member includes basic member info.
type Member struct {
	OdataID     string `json:"@odata.id"`
	MemberId    string `json:"MemberId"`
	Name        string `json:"Name"`
...
// ProductInfo contains product info.
...
// Threshold contains threshold info.
...
// Placement within the addressed location.
...
// Identifier describes any additional identifiers for a resource.
